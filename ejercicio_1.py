...
if __name__ == '__main__':
    ...
    while dato_ok == False:
        try:
            numero = int(input('Ingrese numero a calcular CUADRADO(entero): '))
            dato_ok = True
        except:
            print('Error.. dato ingresado no es ENTERO')

    potencia_2 = lambda x: numero ** 2
    print('Cuadrado de ', numero, 'es ', potencia_2(numero))
    ...
    numeros_potencia = list(map(mult_by_2, numeros))
    print('Multiplo de 2 de ', numeros, numeros_potencia)
